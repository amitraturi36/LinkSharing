...
<body>
<div  style="float: right"><h4><span data-toggle="modal" data-target="#changepassword">Change Password</span></h4>
    </div>
    ...
    <div style="padding:10px;margin:0px 19px;">
        <div class="panel  col-sm-9 " style="border: 1px solid grey;">
            ...
            <div class="panel-body col-sm-7">
                ...
                <span class="text-info col-sm-6">${subtopics.resources.count[0]}</span>
            </div>
        </div></div>
</div>
